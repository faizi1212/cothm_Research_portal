  ...
  return (
    <div className="dashboard-container">
      ...
      <style>{`
        ...
        .search-input:focus { outline: none; border-color: var(--primary); box-shadow: 0 0 0 3px rgba(30, 60, 114, 0.1); }
      ...
      <div className="main-content">
        ...
        <div className="action-header">
          ...
          <button onClick={fetchProjects} className="logout-btn" style={{background: '#3b82f6', border: 'none'}}>
              ...
              <div key={project._id} className="card">
                ...
                <div className="card-body">
                  <div className="meta-row">
                    ...
                    <span className="meta-val">{latestSub?.stage || "Not Started"}</span>
                  </div>
                  <div className="meta-row">
                    <span className="meta-label">Submitted</span>
                    <span className="meta-val">
                      {latestSub ? new Date(latestSub.date).toLocaleDateString() : "-"}
                    </span>
                  </div>
        ...
        <div className="modal-overlay" onClick={handleCloseReview}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <div>
                <h3 style={{margin:0}}>Reviewing: {selectedProject.studentName}</h3>
                <span style={{fontSize:13, color:'#64748b'}}>{selectedProject.studentEmail}</span>
              </div>
            ...
            <div className="modal-body">
              ...
              <div className="doc-preview">
                {selectedProject.submissions?.length > 0 ? (
                  <a 
                    href={selectedProject.submissions[selectedProject.submissions.length - 1].fileUrl} 
                    target="_blank" 
                    rel="noreferrer"
                    className="doc-link"
                  >
                    <FaFilePdf size={24} color="#ef4444"/> 
                    Open {selectedProject.submissions[selectedProject.submissions.length - 1].stage} Document <FaExternalLinkAlt size={12}/>
                  </a>
                ) : (
                  <p style={{color:'#94a3b8'}}>No document submitted yet.</p>
                )}
              </div>
              ...
              <textarea
                ...
                placeholder="Enter your feedback, comments, or reason for rejection here..."
                value={feedback}
